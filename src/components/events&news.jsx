    ...
    <div className="container-lg px-4 my-4">
      <div className="row align-items-stretch">
            ...
            <div className="card custom-shadow border-0 h-100">
              <div className="card-top-line"></div>
                <div className="card-body">
                  <h5 className='pt-2 text-center'>  <i className="bi bi-calendar-event me-1 fs-3 event-icon"  style={{ color: '#B30000' }} ></i><b>Announcements</b></h5>
                  <div className='mt-4 px-lx-5 px-2'>
                      <Link className='my-2 py-1 text-decoration-none text-dark custom-hover-card' to="">
        ...
        <div className="col-md-7">
          <div className="card custom-shadow border-0 h-100 text-start d-flex align-items-center justify-content-center">    
         <div className="card-top-line"></div>
            <div className="card-body">
               <h5 className='pt-2 text-center'>  
                <i className="bi bi-newspaper me-1 fs-3 event-icon"  style={{ color: '#B30000' }} ></i>
                <b>Latest News and Events</b>
               </h5>
               <div className='mt-4 px-lg-5 px-2'>
